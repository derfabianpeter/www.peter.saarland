...
* **Projekt**: Migration interner Anwendungen auf Docker
  ...
  * **Technologien**: 
    ...
    * Git
    * GitLab
* **Projekt**: Private Cloud auf Basis von Docker Swarm
  * **Umfang**: 50 Tage
  * **Aufgaben**: die interne Infrastruktur soll auf einen auf mehrere Standorte verteilten Swarm umgestellt werden
  * **Technologien**:
    * Docker Swarm
    * Git
    * GitLab
...
* **Projekt**: Cloud-Native OAuth2 Middleware
  ...
  * **Technologien**:
    ...
    * Python
    * Postgres
* **Projekt**: GitLab Review Apps
  * **Umfang**: 20 Tage
  * **Aufgaben**: Entwicklung von CI/CD Pipelines für merge-request basierte Review Apps
  * **Technologien**:
    * Docker
    * Docker Compose
    * Git
...
* **Projekt**: Cloud Plattform
  ...
  * **Technologien**:
    ...
    * SemVer
    * LetsEncrypt
    * Vault, Consul, Portainer, Traefik
    * Postgres, RabbitMQ
    * CI/CD
...
* **Projekt**: Media / Signage Cloud
  ...
  * **Technologien**:
    ...
    * Docker
    * Python
    * Screenly / Screenly API (inofficial)
    * BOSE Soundtouch API
    * Raspberry PI
* **Projekt**: Verteilte Hybrid-Cloud als Basis-Infrastruktur für den IT- Betrieb des MVZ
  * **Umfang**: 150 Tage
  * **Aufgaben**: Errichtung und Betrieb einer mehrere Standorte umfassenden verteilten IoT-Infrastruktur die den sicheren Betrieb der medizinischen und organisatorischen Plattformen innerhalb des MVZ unterstützt und sicherstellt.
  * **Technologien**:
    * Docker
    * Python, Postgres, InfluxDB
    * Unifi
    * Raspberry Pi
    * Hager Security Appliances
    * QNAP
    * OPNSense
...
* **Ausbildung**: Fachinformatiker f. Systemintegration
  ...
  * **Technologien**:
    * OpenVZ/VMWare
    * Cisco/Fujitsu/SAN
    * Debian/Ubuntu/HA/Loadbalancing
    * MySQL/OpenVPN/VSphere
    * Nagios/Monit
    * VoIP/Hosting/VLANs
